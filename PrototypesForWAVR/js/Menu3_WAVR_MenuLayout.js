...
function eraseButtonThatHasThisTextMeshId(id) {
...
function clearDisplay() {
    eraseButtonThatHasThisTextMeshId(INSTRUCTION_PANEL);
    eraseButtonThatHasThisTextMeshId(2016      );
    eraseButtonThatHasThisTextMeshId(2015      );
    eraseButtonThatHasThisTextMeshId(2014      );
    eraseButtonThatHasThisTextMeshId(AUDI      );
    eraseButtonThatHasThisTextMeshId(BMW       );
    eraseButtonThatHasThisTextMeshId(MERCEDES  );
    eraseButtonThatHasThisTextMeshId(LAVAL     );
    eraseButtonThatHasThisTextMeshId(MONTREAL  );
    eraseButtonThatHasThisTextMeshId(CHATEAUGAY);
}
...
var menuLayout_BrandButton = {
    layoutInfo: {
        layoutStartPos:             {x:0, y:-10, z:-MENU_DISTANCE},
...
var menuLayout_YearButton = {
    ...
    leaveMenuFunction:          function() {/*TBD*/},
    layoutInfo:{
        layoutStartPos:         {x:-13, y:-10, z:-MENU_DISTANCE},
        layoutIncrement:        {x:0, y:4},
        layoutSize:             {length:12, height:3}
    },
    text:                       "Year: Any",
...
var menuLayout_RemoveAllPopUpButtons_Button = {
    layoutInfo: {
        layoutStartPos:             {x:30, y:-10, z:-MENU_DISTANCE},
        layoutIncrement:            {x:0, y:4},
...
var menuLayout_InstructionsPanel = {
    layoutInfo: {
        layoutStartPos:             {x:0, y:30, z:-3*MENU_DISTANCE},
        layoutIncrement:            {x:0, y:20},
        layoutSize:                 {length:100, height:85}
    },
    text:        [
        "UI prototype: \"Menu3\"",
        "",
        ...
        "       + POP-UP menu;",
        "       + current selection;",
        "       + 3 kinds of gaze timer feedback;",
        "       + 200 pictures are loaded during run-time;",
        "       + when we make a choice, there are pictures that are randomly removed and there are pictures that are randomly added;",
        "       + the pictures that are added follow the ribbon from the top extremity. THIS WILL HAVE TO BE IMPROVED FOR SURE.",
        "",
        "Instructions:",
...
function setYear(yearString) {
    ...
    TO_DELETE_RANDOMIZE_RIBBON_NOW(database);
}
